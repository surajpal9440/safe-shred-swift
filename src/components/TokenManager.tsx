...
interface TokenManagerProps {
  ...
  try {
    const response = await fetch("https://your-backend.com/api/activate-token", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${ssoToken}`, // From SSO login
      },
      body: JSON.stringify({ token: newTokenCode }),
    });
